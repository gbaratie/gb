...
export const amisItems: LinkItem[] = [
  {
    id: 'colco',
    title: 'Colco',
    description: 'Un café de spécialité enrichi en collagène, à la croisée du goût et du bien-être.',
    tags: ['café', 'collagène'],
    url: 'https://colco.fr/',
  ...
  },
  {
    id: 'chalong-bay',
    title: 'Chalong Bay',
    description: 'Un rhum artisanal distillé en Thaïlande par des français et reconnu pour sa qualité à l’international.',
  ...
  },
  {
    id: 'saneha',
    title: 'Saneha',
    description: 'Saneha, un Gin premium d’inspiration thaïlandaise, au design graphique affirmé.',
